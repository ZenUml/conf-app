function main() {
  ...
  .groupBy([function (e) { return e.properties.macro_type || "unset"; }], [
    mixpanel.reducer.count(),
    mixpanel.reducer.numeric_percentiles("properties.duration_ms", P),
    mixpanel.reducer.numeric_percentiles("properties.bootstrap_ms", [50, 90]),
    mixpanel.reducer.numeric_percentiles("properties.context_ms", [50, 90]),
    mixpanel.reducer.numeric_percentiles("properties.fetch_ms", [50, 90]),
    mixpanel.reducer.numeric_percentiles("properties.render_ms", [50, 90]),
    mixpanel.reducer.numeric_percentiles("properties.measured_sum_ms", [50, 90])
  ]);
}
