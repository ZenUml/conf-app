...
function main(){
  ...
  .groupBy(['name', function(e){return String(e.properties.banner_audience);}, function(e){return String(e.properties.is_space_admin);}, 'properties.client_domain'], mixpanel.reducer.count())
