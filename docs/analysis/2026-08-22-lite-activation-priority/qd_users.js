...
function main(){
  ...
  .groupBy(['name', function(e){return String(e.properties.banner_audience);}, function(e){return String(e.properties.is_space_admin);}, 'distinct_id'], mixpanel.reducer.count())
  .groupBy([function(r){return r.key[0]+'|aud='+r.key[1]+'|admin='+r.key[2];}], [mixpanel.reducer.count(), mixpanel.reducer.sum(function(r){return r.value;})]);
}
