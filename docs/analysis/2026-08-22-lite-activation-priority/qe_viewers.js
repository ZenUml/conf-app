...
function main(){
  ...
  .groupBy([function(e){return String(e.properties.surface);}, 'distinct_id'], mixpanel.reducer.count())
  .groupBy([function(r){return 'macro_viewed|surf='+r.key[0];}], [mixpanel.reducer.count(), mixpanel.reducer.sum(function(r){return r.value;})]);
}
