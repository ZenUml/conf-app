...
function main(){
  return Events({from_date:'2026-04-18', to_date:'2026-08-22', event_selectors:[{event:'embed_autoconvert_detected'},{event:'embed_autoconvert_target_resolved'}]})
  .filter(function(e){ return !isInternal(e.properties.client_domain) && okUser(e); })
  .groupBy(['name', 'distinct_id'], mixpanel.reducer.count())
