...
const props = defineProps<{
  /** Runs Swagger React bootstrap + document hydration after the shell is in the DOM */
  onMountedBootstrap?: () => void | Promise<void>
}>()

onMounted(() => {
  void props.onMountedBootstrap?.()
})
</script>
