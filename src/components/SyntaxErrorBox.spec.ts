...
describe('SyntaxErrorBox AI Repair routing', () => {
  ...
  it('hides the repair action when AI Repair is disabled', async () => {
    ...
    expect(featureFlags.isAiChatEnabled).not.toHaveBeenCalled()
  })
  ...
  it('routes repair through AI Chat when both flags are enabled', async () => {
