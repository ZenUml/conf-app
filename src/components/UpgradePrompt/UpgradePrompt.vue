  ...
  <Teleport to="body">
    <div ref="modalContainer" v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center p-4" tabindex="-1" @keydown.esc="tracking.handleClose">
      ...
      <div class="relative bg-white rounded-lg shadow-xl w-[680px] max-h-[660px] overflow-y-auto">
        ...
        <!-- Support-assisted extension CTA: expands to an in-modal form (no
             external portal hop — the JSM ticket is created via our backend) -->
        <div class="px-4 pb-3">
          <div class="rounded-md border border-blue-100 bg-blue-50 px-3 py-2">
            <div v-if="!extensionFormExpanded" class="flex items-center justify-between gap-3">
              ...
              <button
                ...
                @click="extensionFormExpanded = true"
...
import ExtensionRequestForm from './ExtensionRequestForm.vue'
...
const extensionFormExpanded = ref(false)
