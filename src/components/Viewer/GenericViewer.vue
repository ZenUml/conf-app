      ...
      <div class="header flex px-1" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
        <div class="left">
          <div class="actions flex" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
            ...
            <button @click="edit" v-show="showEdit" class="flex justify-center items-center p-1 rounded hover:bg-gray-300">
            ...
            <button @click="fullscreen" class="p-1 rounded hover:bg-gray-300">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
