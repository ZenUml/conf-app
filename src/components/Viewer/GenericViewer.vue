      ...
      <div class="header flex p-1.5" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
        <div class="left">
          <div class="actions flex" :class="{flex: isDisplayMode, hidden: !isDisplayMode}">
            ...
            <button @click="edit" v-show="showEdit" class="flex justify-center items-center p-1 mx-1 rounded hover:bg-gray-300">
            ...
            <button @click="fullscreen" class="p-1 mx-1 rounded hover:bg-gray-300">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button v-show="!isLite || exportPngEnabled" @click="downloadPng" class="flex justify-center items-center px-2 rounded hover:bg-gray-300" title="Download PNG">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button v-show="isLite && (exportPngTrial && !exportPngEnabled)" @click="downloadPng" class="flex justify-center items-center px-2 rounded hover:bg-gray-300" title="Download PNG">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.5625" y="1.62012" width="16.875" height="14.7656" rx="2.10938" fill="#42526E"/>
                <path d="M2.96934 10.1689V9.30986H4.03366C4.27153 9.30986 4.45654 9.24909 4.5887 9.12756C4.72288 9.00602 4.78997 8.8299 4.78997 8.59918V8.593C4.78997 8.36023 4.72288 8.1841 4.5887 8.06463C4.45654 7.94515 4.27153 7.88541 4.03366 7.88541H2.96934V7.01406H4.30508C4.63241 7.01406 4.91704 7.07998 5.15898 7.21181C5.40092 7.34159 5.58796 7.52493 5.72011 7.76182C5.8543 7.99665 5.92139 8.27371 5.92139 8.593V8.59918C5.92139 8.91641 5.8543 9.19347 5.72011 9.43037C5.58796 9.6652 5.40092 9.8475 5.15898 9.97728C4.91704 10.105 4.63241 10.1689 4.30508 10.1689H2.96934ZM2.4082 11.4728V7.01406H3.52742V11.4728H2.4082Z" fill="#E5E5E5"/>
                <path d="M6.74479 11.4728V7.01406H7.63834L9.76698 9.92166L8.97408 9.51997H9.52911V7.01406H10.5904V11.4728H9.70294L7.56819 8.54047L8.3611 8.94525H7.80607V11.4728H6.74479Z" fill="#E5E5E5"/>
...
<!--            https://zenuml.com/confluence-migration-instructions/-->
            <a v-show="isLite && exportPngLocked && !exportPngEnabled && !exportPngTrial" @click="trackUpgradeEvent"
               ...
               class="flex justify-center items-center px-2 rounded hover:bg-gray-300" title="Download PNG">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.5625" y="1.62012" width="16.875" height="14.7656" rx="2.10938" fill="#42526E"/>
                <path d="M2.96934 10.1689V9.30986H4.03366C4.27153 9.30986 4.45654 9.24909 4.5887 9.12756C4.72288 9.00602 4.78997 8.8299 4.78997 8.59918V8.593C4.78997 8.36023 4.72288 8.1841 4.5887 8.06463C4.45654 7.94515 4.27153 7.88541 4.03366 7.88541H2.96934V7.01406H4.30508C4.63241 7.01406 4.91704 7.07998 5.15898 7.21181C5.40092 7.34159 5.58796 7.52493 5.72011 7.76182C5.8543 7.99665 5.92139 8.27371 5.92139 8.593V8.59918C5.92139 8.91641 5.8543 9.19347 5.72011 9.43037C5.58796 9.6652 5.40092 9.8475 5.15898 9.97728C4.91704 10.105 4.63241 10.1689 4.30508 10.1689H2.96934ZM2.4082 11.4728V7.01406H3.52742V11.4728H2.4082Z" fill="#E5E5E5"/>
                <path d="M6.74479 11.4728V7.01406H7.63834L9.76698 9.92166L8.97408 9.51997H9.52911V7.01406H10.5904V11.4728H9.70294L7.56819 8.54047L8.3611 8.94525H7.80607V11.4728H6.74479Z" fill="#E5E5E5"/>
            ...
            <button v-show="showLikeButton" @click="likeDiagram" class="flex justify-center items-center px-2 rounded hover:bg-gray-300" style="width: 50px;" title="Like this diagram">
...
import { createDiagramLike, getDiagramLikes } from "@/services/DiagramLikes";
...
export default {
  ...
  async mounted() {
    try {
      ...
      if (this.showLikeButton) {
        const count = (await getDiagramLikes(this.diagram.id)).length;
        this.likesCount = count > 0 ? count : '';
      }
    } catch (e) {
  ...
  methods: {
    ...
    async likeDiagram() {
      ...
      console.log('likeDiagram', store.state.diagram.id);
      await createDiagramLike(store.state.diagram.id);
    },
  },
}
</script>
