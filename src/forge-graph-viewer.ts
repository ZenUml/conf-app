...
async function loadDiagram() {
  ...
  if(!customContentId) {
    ...
    if (loaded.recoveredFromOrphanId) {
      // ZEN-1170 Defect 2b: rendered recovered sibling CC.
      ...
      // Orphan with no confident candidate — telemetry only, fall through to NULL_DIAGRAM.
