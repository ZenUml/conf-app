...
import { getMermaidPhaseTimings } from '../mermaid/renderPhaseTiming';
...
export function trackRenderTime(
  ...
  const phaseTimings = macroType === 'mermaid' ? getMermaidPhaseTimings() : {};
  trackAnalyticsEvent('macro_viewed', {
    ...
    ...(dslLength !== undefined && { dsl_length: dslLength }),
    ...phaseTimings,
  });
}
